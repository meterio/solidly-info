...
const theme = (darkMode, color) => ({
  ...
  uniswapPink: darkMode ? '#06D3D7' : 'black',
  ...
  //primary colors
  primary1: darkMode ? '#2172E5' : '#06D3D7',
  ...
  // color text
  primaryText1: darkMode ? '#6da8ff' : '#06D3D7',

  // secondary colors
  secondary1: darkMode ? '#2172E5' : '#06D3D7',
  ...
  background: darkMode ? 'black' : `radial-gradient(50% 50% at 50% 50%, #06D3D730 0%, #fff 0%)`
})
