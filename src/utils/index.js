...
export function getPoolLink(token0Address, token1Address = null, remove = false) {
  if (!token1Address) {
    return (
      `https://solidly-exchange-beta.vercel.app/#/` +
      (remove ? `remove` : `add`) +
...
export function getSwapLink(token0Address, token1Address = null) {
  if (!token1Address) {
    return `https://solidly-exchange-beta.vercel.app/#/swap?inputCurrency=${token0Address}`
  } else {
    return `https://solidly-exchange-beta.vercel.app/#/swap?inputCurrency=${token0Address === '0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2' ? 'ETH' : token0Address
...
export const urls = {
  showTransaction: tx => `https://scan-warrringstakes.meter.io/tx/${tx}/`,
  showAddress: address => `https://scan-warrringstakes.meter.io/address/${address}/`,
  showToken: address => `https://scan-warrringstakes.meter.io/address/${address}/`,
  showBlock: block => `https://scan-warrringstakes.meter.io/block/${block}/`
}
